...
{
    /// <summary>
    /// FileName: ChineseHelper.cs
    /// CLRVersion: 4.0.30319.18408
    /// Author: dlli5
    /// Corporation: 
    /// Description: 
    /// DateTime: 2014/5/19 16:05:51
    /// </summary>
    public class ChineseHelper
    {
        private static string MoneyNum = "零一二三四五六七八九";
        private static string NumUnit = "十百千万十百千亿";
        public static string ToChinese(int num)
        {
            if (num > 99)
            {
                throw new ArgumentException("不处理大于100的数");
            }

            if (num <= 9)
            {
                return MoneyNum[num].ToString();
            }
            ...
            {
                return "十" + MoneyNum[gewei].ToString();
            }
            else if (shi > 1 && gewei == 0)
            {
                return MoneyNum[shi].ToString() + "十";
            }
            else
            {
                return MoneyNum[shi].ToString() + "十" + MoneyNum[gewei].ToString();
            }
        }
    ...
    "Zhuang","Zhui","Zhun","Zhuo","Zi","Zong","Zou","Zu","Zuan","Zui","Zun","Zuo"
        ...
        /// <param name="hzString">汉字字符串</param>
        /// <returns>转换后的拼音(全拼)字符串</returns>
        public static string ConvertToPinYin(string hzString, int maxLength)
        {
            ...
            if (hzString == "琛" || hzString == "岑")
            {
                return "cen";
            }
            if (hzString == "楠" || hzString == "囡")
            {
                return "nan";
            }
            if (hzString == "睿" || hzString == "芮")
            {
                return "rui";
            }
            if (hzString == "烨" || hzString == "僷")
            {
                return "rui";
            }
            if (hzString == "烊")
